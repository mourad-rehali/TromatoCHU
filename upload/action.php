...
if(isset($_POST["action"]))
{
 if($_POST["action"] == "fetch")
 {
  ...
  <table class="table table-bordered table-striped">
   <tr>
    ...
    <th>Supprimer</th>
    <th>Télécharger un fichier</th>
    <th>Afficher le fichier téléchargé</th>
   </tr>
   ';
  if(count($folder) > 0)
  {
   foreach($folder as $name)
   {
    $output .= '
     <tr>
      ...
      <td><button type="button" name="upload" data-name="'.$name.'" class="upload btn btn-info btn-xs">Télécharger un fichier</button></td>
      <td><button type="button" name="view_files" data-name="'.$name.'" class="view_files btn btn-default btn-xs">Afficher le fichier téléchargé</button></td>
     </tr>';
   }
  }
  else
 ...
 if($_POST["action"] == "change")
 {
  if(!file_exists($_POST["folder_name"]))
  {
   ...
   echo 'Changement de nom de dossier';
  }
  else
  {
   echo 'Dossier déjà créé';
 ...
 if($_POST["action"] == "change_file_name")
 {
  ...
  {
   echo 'Changement de nom de fichier réussi';
  }
  else
  {
